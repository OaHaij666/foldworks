...
public final class MovingChestRuntime implements AutoCloseable {
    ...
    private final MovingHomesteadChestBlockEntity chest;
    ...
    private MovingChestRuntime(MovingHomesteadChestBlockEntity chest, String dimensionKey, BlockPos graphPos, BlockState state) {
        this.chest = chest;
    ...
    public static MovingChestRuntime create(ServerLevel level, BlockState state, CompoundTag blockEntityData) {
        ...
        MovingHomesteadChestBlockEntity chest = new MovingHomesteadChestBlockEntity(graphPos, state);
