package com.foldworks.compat.item;
 ...
 */
public class FoldworksChestItemHandler implements IItemHandler {
    private final BaseChestBlockEntity chest;
    private final boolean canInsert;
    private final boolean canExtract;

    public FoldworksChestItemHandler(BaseChestBlockEntity chest) {
        this(chest, true, true);
    }

    public FoldworksChestItemHandler(BaseChestBlockEntity chest, boolean canInsert, boolean canExtract) {
        this.chest = chest;
