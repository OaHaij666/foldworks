...
public class ProductionSpaceChunkGenerator extends ChunkGenerator {
    ...
    public static final MapCodec<ProductionSpaceChunkGenerator> CODEC = RecordCodecBuilder.mapCodec(
            ...
            ).apply(instance, (biomeSource, seed, spaceId) -> new ProductionSpaceChunkGenerator(
                    biomeSource,
                    seed,
    ...
    private static UUID parseSpaceId(String spaceId) {
        ...
        try {
            ...
            Foldworks.LOGGER.warn("无法解析 space_id '{}', 维度将无空间关联", spaceId);
            return null;
        }
    }
    ...
    public ProductionSpaceChunkGenerator(BiomeSource biomeSource, long seed) {
        this(biomeSource, seed, null);
    }

    public ProductionSpaceChunkGenerator(BiomeSource biomeSource, long seed, UUID spaceId) {
        super(biomeSource);
        this.seed = seed;
